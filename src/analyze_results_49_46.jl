...
open(joinpath(results_folder,"comparison_results_$(name_file)_2_6.json"),"w") do f 
...
result_congested_comparison = JSON.parsefile(joinpath(results_folder,"comparison_results_$(name_file)_2_6.json"))
...
savefig(joinpath(results_figures_folder,"$(name_file)_distribution_$(n_timesteps)_timesteps_2_6.png"))
savefig(joinpath(results_figures_folder,"$(name_file)_distribution_$(n_timesteps)_timesteps_2_6.pdf"))
savefig(joinpath(results_figures_folder,"$(name_file)_distribution_$(n_timesteps)_timesteps_2_6.svg"))
