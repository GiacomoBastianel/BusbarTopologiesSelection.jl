function constraint_power_balance_choose_topology(pm::_PM.AbstractPowerModel, i::Int; nw::Int=nw_id_default)
    ...
    constraint_power_balance_choose_topology(pm, nw, i, bus_arcs, bus_arcs_dc, bus_arcs_sw, bus_gens, bus_storage, bus_pd, bus_qd, bus_gs, bus_bs)
end
